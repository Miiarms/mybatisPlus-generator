 ...
 *
 */
public class LombokPluginForPlus extends PluginAdapter {
    ...
    public boolean modelBaseRecordClassGenerated(TopLevelClass topLevelClass, IntrospectedTable introspectedTable) {
        ...
        String tableName = String.join(".", introspectedTable.getTableConfiguration().getSchema(), introspectedTable.getTableConfiguration().getTableName());
...
//        }
        ...
        topLevelClass.addJavaDocLine("* @author miiarms " );
